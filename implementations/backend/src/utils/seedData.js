/**
 * Single source of truth for initial car seed data.
 * Format: [brand, model, type, license_plate, price_per_day, location, discount_percent, is_promotion]
 */
const SAMPLE_CARS = [
...
const SEED_INSERT_QUERY = 'INSERT INTO cars (brand, model, type, license_plate, price_per_day, location, discount_percent, is_promotion) VALUES ?';

/** Models that should default to promotion status */
const PROMO_MODELS = ['Camry', 'Altima', '320i', 'CR-V', 'X5', 'Fortuner', 'Alphard', 'Carnival', 'V-Class', 'Corolla', 'Rogue'];

module.exports = { SAMPLE_CARS, SEED_INSERT_QUERY, PROMO_MODELS };
